    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600">
          Buat rencana workout untuk mencapai target kalori kamu
        </p>
      </div>
      ...
      <div class="grid lg:grid-cols-3 gap-6">
            ...
            <form @submit.prevent="calculateWorkout">
              ...
              <div class="mb-6">
                ...
                <div
                  ...
                  class="mt-4 p-4 bg-bright-blue bg-opacity-10 rounded-xl"
                >
                  <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                      <p class="text-2xl font-bold text-bright-blue">
                        {{ selectedActivity.calories_per_hour_70kg }}
                      </p>
              ...
              <div
                v-if="error"
                class="mb-4 p-4 bg-red-50 border-2 border-red-200 rounded-xl text-red-700 text-sm"
              >
        ...
        <div class="lg:col-span-1">
          <div v-if="result" class="glass rounded-2xl p-6 sticky top-24">
            ...
            <!-- Activity Name -->
            <div
              class="mb-4 p-4 bg-gradient-to-r from-bright-blue to-lime rounded-xl text-white"
            >
            ...
            <div class="space-y-3 mb-4">
              <div
                class="flex items-center justify-between p-3 bg-white bg-opacity-50 rounded-lg"
              >
              ...
              <div
                class="flex items-center justify-between p-3 bg-bright-blue bg-opacity-10 rounded-lg border-2 border-bright-blue"
              >
                <div class="flex items-center space-x-2">
          ...
          <div v-else-if="loading" class="glass rounded-2xl p-6">
            <div class="text-center">
              <i
                class="fas fa-spinner fa-spin text-4xl text-bright-blue mb-4"
              ></i>
          ...
          <div class="flex items-center justify-between mb-6">
            ...
            >
              <i
                ...
                :class="{ 'fa-spin': loadingRecommendations }"
              ></i>
            ...
            >
              ...
              <div class="p-6 pl-20">
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <!-- Frequency -->
                  <div
                    class="text-center p-3 bg-white bg-opacity-60 rounded-lg"
                  >
                ...
                <div class="mt-4 grid grid-cols-3 gap-3">
                  <div
                    class="text-center p-2 bg-white bg-opacity-40 rounded-lg"
                  >
              ...
              <div v-if="index === 0" class="absolute top-4 right-4">
                <span
                  class="px-3 py-1 bg-yellow-400 text-yellow-900 rounded-full text-xs font-bold shadow-lg"
                >
      ...
      <div class="mt-6 glass rounded-xl p-6 border-l-4 border-bright-blue">
        ...
        <div class="space-y-2 text-sm text-gray-700">
          <p>
            <strong>Algoritma API</strong> menghitung frekuensi optimal
            berdasarkan target kalori dan durasi maksimal per sesi.
          </p>
          <p>
            <strong>Contoh:</strong> Jika target kalori sangat tinggi dan durasi
            per sesi dibatasi (misal 2 jam max), API akan meningkatkan frekuensi
            hingga 7 hari untuk mencapai target, meskipun kamu set max 5 hari.
          </p>
          <p class="pt-2 border-t border-gray-200">
            <strong>Solusi:</strong>
            <span class="inline-flex space-x-2 ml-2">
              <span class="px-2 py-1 bg-bright-blue bg-opacity-10 rounded"
                >Turunkan target kalori</span
              >
              <span>atau</span>
              <span class="px-2 py-1 bg-lime bg-opacity-10 rounded"
                >Pilih aktivitas lebih intensif (MET lebih tinggi)</span
              >
            </span>
          </p>
        </div>
